...
public class Level3Screen extends LevelScreen implements Screen {
	...
	public Level3Screen(ThomasMain g) {
		super(g);
		// Inizializzazione entità
		minions = new Array<>();
		// ... setup camera e batch ...
		background = new Texture("kungfum_3_floor.png");
		this.levelInfo = new LevelInfo();
		this.levelInfo.setFloor(3);
		this.levelInfo.setLevelBeginX(LevelConstants.THIRD_FLOOR_RIGHT_HOLE);
		this.levelInfo.setRespawnX(LevelConstants.THIRD_FLOOR_RIGHT_START); // Punto di partenza
		this.levelInfo.setGoalX(LevelConstants.THIRD_FLOOR_LEFT_STAIR); // Punto di arrivo
		this.levelInfo.setGroundY(LevelConstants.THIRD_FLOOR_GROUND_Y);
		this.levelInfo.setGripperSpeed(LevelConstants.THIRD_FLOOR_GRIPPER_SPEED);
		this.levelInfo.setKnifeThrowerSpeed(LevelConstants.THIRD_FLOOR_KNIFE_THROWER_SPEED);
		this.levelInfo.setKnifeSpeed(LevelConstants.THIRD_FLOOR_KNIFE_SPEED);
		this.levelInfo.setKnifeInterval(LevelConstants.THIRD_FLOOR_KNIFE_INTERVAL);
		this.levelInfo.setMaxKnifeThrowers(LevelConstants.MAX_KNIFE_THROWERS_THIRD_FLOOR);
		this.levelInfo.setMaxEnemies(LevelConstants.MAX_ENEMIES_THIRD_FLOOR);
		this.levelInfo.setSpawnOffset(LevelConstants.SPAWN_OFFSET_THIRD_FLOOR);
		this.levelInfo.setCameraY(LevelConstants.THIRD_FLOOR_Y);
		this.levelInfo.setSpawnInteval(LevelConstants.SPAWN_INTERVAL_THIRD_FLOOR);
		this.levelInfo.setCeilingY(LevelConstants.THIRD_FLOOR_CEILING);
		this.levelInfo.setBossDistance(LevelConstants.THIRD_FLOOR_BOSS_DISTANCE);
		camera.position.x = this.levelInfo.getLevelBeginX();
		camera.position.y = this.levelInfo.getCameraY();
		trapdoor = new Trapdoor(LevelConstants.THIRD_FLOOR_TRAPDOOR_X, LevelConstants.THIRD_FLOOR_TRAPDOOR_Y, false);
		player = new Player(levelInfo.getLevelBeginX(), levelInfo.getGroundY(), this, levelInfo);
		System.out.println(levelInfo.toString());
		boss = new Giant(LevelConstants.THIRD_FLOOR_LEFT_STAIR, LevelConstants.THIRD_FLOOR_GROUND_Y);
